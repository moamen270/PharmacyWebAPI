...
namespace PharmacyWebAPI.Utility.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
        ...
        public async Task<string> AddRoleAsync(UserRolesDto model)
        {
